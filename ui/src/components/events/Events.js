    ...
    return(<>
        <div className="hero min-h-[50%] py-16">
            ...
            <div className="max-w-md">
                <h1 className="text-5xl font-bold text-metal">Events where Chopper was Involved</h1>
            </div>
            </div>
        </div>
        ...
        <div className="text-xl max-w-md mx-auto text-center">
            <p className="font-bold text-metal">There aren't any events to display at the moment! Sorry about that! </p>
        </div>
        :  posts.map(post => {
                return(
